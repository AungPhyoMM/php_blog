                ...
                <?php if ($result) {
                  ...
                  foreach ($result as $value) { ?>
                    <tr>
                      ...
                      <td><?= escape(substr($value['content'], 0, 100)) ?></td>
                      <td>
                        <div class="btn-group">
                          <div class="container">
                          ...
                          <div class="container">
                            <a href="delete.php?id=<?= $value['id'] ?>" type="button" class="btn btn-danger" onclick="return confirm('Are you want to delete this item?');">Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
